    ...
    return (
        <div className='products_page'>
            ...
            <div className='form_input'>
                <legend>Form Master Data Product</legend>
                <form onSubmit={editMode ? handleUpdate : handleSubmit}>
                    <div className="form-group row">
                        <label htmlFor="inputProducts" className="col-sm-2 col-form-label">Nama Products</label>
                    ...
                    <div className="form-group row">
                        <label htmlFor="inputDesc" className="col-sm-2 col-form-label">Description of Products</label>
                        <div className="col-sm-10">
                            <textarea 
                                className="form-control" 
                    ...
                    <fieldset className="form-group">
                        <div className="row">
                            <span className="col-form-label col-sm-2 pt-0">Gender</span>
                            <div className="col-sm-10" style={{display:'flex'}}>
                                ...
                                <div className="form-check" style={{marginLeft:'10px'}}>
                                    <input 
                                        ...
                                        id="gridRadios2" 
                                        value="All Gender"
                                        checked={formData.gender === 'All Gender'}
                                        onChange={handleChange}
                                    />
                                    <label className="form-check-label" htmlFor="gridRadios2">
                                        All Gender
                    ...
                    <div className="form-group row">
                        <label htmlFor="inputPrice" className="col-sm-2 col-form-label">Image Product</label>
                        <div className="col-sm-10">
                            <input 
                                type="file" 
                    ...
                    <div className="form-group row">
                        <div className="col-sm-10">
                            <button type="submit" className="btn btn-primary">{editMode ? 'Update Product' : 'Save Product'}</button>
                        </div>
                    </div>
                </form>
            </div>
            <div className='list_products'>
                <legend>All List Products us at...</legend>
